...
| 出生年月 | 1996年04月                                      | 邮箱    | 1915766026@qq.com                         |
| 现住址  | 江苏省连云港市海州区海连路                                 | 是否已婚  | 已婚                                        |
| 学历   | 本科                                            | 专业    | 数字媒体技术                                    |
...
- [稀土掘金](https://juejin.cn/user/4182956056773160/posts)
  优秀创作者，[CSDN](https://blog.csdn.net/little_stick_i?type=blog) 万粉博主，个人公众号 程序员阿杆，**全网阅读量超 80W**
...
<span>一、江苏大塔科技有限公司 - 研发部</span><span>前端工程师</span><span>2022.11 - 至今</span>
</h4>

- 公司的多个后台管理系统的编写，负责前端框架的搭建、页面的编写、逻辑交互优化与数据联调。
- 小程序、uni-app项目的开发，负责主要模块内容的编写
- 3D可视化大屏的相关开发与优化
...
<h4 style="display: flex;justify-content: space-between;">
<span>一、智慧管廊管理系统</span><span>主力开发</span><span>2022.10 - 至今</span>
</h4>
项目背景及描述：

- 承接xx管廊公司的系统，涉及多个模块的开发，如：商务模块、施工模块、模型管理、巡检模块、培训模块、应急模块、管廊模块、管线模块、设备模块等17个大模块，每个模块下还有多个子模块。涉及到7大公司类型的平台切换，数据独立

我的工作内容：

- 参与需求和功能分析与建议，并确定技术方案；
...
> 基于Spring + Mybatis-Plus + MySQL + Redis + RabbitMQ + ES + Docker + Nacos + Fegin的微服务项目。是个类似于CSDN的博客社区，但博客的推送是基于院校的。
**<u>GitHub Star
> 380+</u>，[开源地址](https://github.com/stick-i/scblogs)，[系统架构图](https://gitee.com/sticki/scblogs/raw/main/document/image/scblogs-framework.png)
**。
...
> 基于 SpEL 的参数校验包，也是 javax.validation 的扩展增强包，用于简化参数校验。**<u>GitHub Star
70+</u>，[开源地址](https://github.com/stick-i/spel-validator)**。
